...
function setTheme(isDark) {
  ...
  html.setAttribute('data-theme', isDark ? 'business' : 'business-light')
  localStorage.setItem('theme', isDark ? 'business' : 'business-light')
...
onMounted(() => {
  ...
  isDarkTheme.value = savedTheme ? savedTheme === 'business' : prefersDark
